...
Original file is located at
    https://colab.research.google.com/drive/1p2xQxL9pFnTcrffbuzlAk70oGQRpVKaI
...
data_dir = './dataset/plant-seedlings-classification/' # dataset's dir you want to unzip
#data_dir = 'C:/Users/wayne/Desktop/course/ML/env/HW1/dataset/plant_seedlings_classification/' # dataset's dir you want to unzip
if not os.path.exists(data_dir):
  zip_dir = './dataset/plant-seedlings-classification.zip' # your zip file's dir
  #zip_dir = 'C:/Users/wayne/Desktop/course/ML/env/HW1/dataset/plant_seedlings_classification.zip' # your zip file's dir
...
print('Step 1 Custom Pytorch Dataset')
...
plt.tight_layout()
plt.show()
print('Step 2 Split train, valid set and Create Dataloader:')
...
print(x)
print(y)
print('Step 4 Define Train Function(for one epoch)')
...
print(loss, acc)
print('Define Valid Function(for one epoch)')
...
print(loss, acc)
print('Step 6 Plot Learning Curve Function')
...
print('Step 8 Main Function(training pipeline)')
...
main()
print('Step 9 Addition: Customize your own model')
